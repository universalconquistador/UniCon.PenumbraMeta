...
public record class MultiGroup(int Version, string Name, string? Description, string? Image, int Page, int Priority, int DefaultSettings, Guid Id,
    ...
    : Group(Version, Name, Description, Image, Page, Priority, DefaultSettings, Id, Layout, Condition)
{
    ...
    public override TResult Visit<TVisitor, TParam, TResult>(ref TParam param) => TVisitor.VisitMultiGroup(this, ref param);
}
